...
func (Service_Node_Status) EnumDescriptor() ([]byte, []int) {
	return file_nodeum_micro_v1_monitoring_proto_rawDescGZIP(), []int{0, 0, 0}
}
...
type Service_Node struct {
	...
	Stats   *Service_Node_StatsResponse `protobuf:"bytes,3,opt,name=stats,proto3" json:"stats,omitempty"`
...
func (*Service_Node) Descriptor() ([]byte, []int) {
	return file_nodeum_micro_v1_monitoring_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *Service_Node) GetStats() *Service_Node_StatsResponse {
	if x != nil {
		return x.Stats
	}
	return nil
...
type Service_Node_StatsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *Service_Node_StatsResponse) Reset() {
	*x = Service_Node_StatsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *Service_Node_StatsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Service_Node_StatsResponse) ProtoMessage() {}

func (x *Service_Node_StatsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_nodeum_micro_v1_monitoring_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Service_Node_StatsResponse.ProtoReflect.Descriptor instead.
func (*Service_Node_StatsResponse) Descriptor() ([]byte, []int) {
	return file_nodeum_micro_v1_monitoring_proto_rawDescGZIP(), []int{0, 0, 0}
}

func (x *Service_Node_StatsResponse) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
func (x *Service_Node_StatsResponse) GetStarted() int64 {
	if x != nil {
		return x.Started
	}
	return 0
...
func (x *Service_Node_StatsResponse) GetUptime() int64 {
	if x != nil {
		return x.Uptime
	}
	return 0
...
func (x *Service_Node_StatsResponse) GetMemory() int64 {
	if x != nil {
		return x.Memory
	}
	return 0
...
func (x *Service_Node_StatsResponse) GetThreads() int64 {
	if x != nil {
		return x.Threads
	}
	return 0
...
func (x *Service_Node_StatsResponse) GetGc() int64 {
	if x != nil {
		return x.Gc
	}
	return 0
...
func (x *Service_Node_StatsResponse) GetRequests() int64 {
	if x != nil {
		return x.Requests
	}
	return 0
...
func (x *Service_Node_StatsResponse) GetErrors() int64 {
	if x != nil {
		return x.Errors
	}
	return 0
...
var file_nodeum_micro_v1_monitoring_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xbd, 0x04, 0x0a, 0x07, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x12, 0x0a,
	0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d,
	0x65, 0x12, 0x18, 0x0a, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x76, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x33, 0x0a, 0x05, 0x6e,
	0x6f, 0x64, 0x65, 0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x6e, 0x6f, 0x64,
	...
	0x1a, 0xce, 0x03, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x61, 0x64, 0x64,
	0x72, 0x65, 0x73, 0x73, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x61, 0x64, 0x64, 0x72,
	0x65, 0x73, 0x73, 0x12, 0x41, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x73, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x2b, 0x2e, 0x6e, 0x6f, 0x64, 0x65, 0x75, 0x6d, 0x2e, 0x6d, 0x69, 0x63, 0x72,
	0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x4e, 0x6f, 0x64,
	0x65, 0x2e, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x52,
	...
	0x61, 0x74, 0x75, 0x73, 0x1a, 0xd5, 0x01, 0x0a, 0x0d, 0x53, 0x74, 0x61, 0x74, 0x73, 0x52, 0x65,
	...
	,
	...
	0x0a, 0x0c, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x41, 0x4c, 0x49, 0x56, 0x45, 0x10, 0x01,
	0x12, 0x0f, 0x0a, 0x0b, 0x53, 0x54, 0x41, 0x54, 0x55, 0x53, 0x5f, 0x44, 0x45, 0x41, 0x44, 0x10,
	0x02, 0x22, 0x15, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	...
	0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x52, 0x08, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x32, 0x83, 0x01, 0x0a, 0x11, 0x4d, 0x6f, 0x6e, 0x69, 0x74,
	0x6f, 0x72, 0x69, 0x6e, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x6e, 0x0a, 0x0c,
	0x4c, 0x69, 0x73, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x12, 0x24, 0x2e, 0x6e,
	0x6f, 0x64, 0x65, 0x75, 0x6d, 0x2e, 0x6d, 0x69, 0x63, 0x72, 0x6f, 0x2e, 0x76, 0x31, 0x2e, 0x4c,
	...
	0x0b, 0x12, 0x09, 0x2f, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x42, 0x3b, 0x5a, 0x39,
...
var file_nodeum_micro_v1_monitoring_proto_goTypes = []interface{}{
	...
	(*Service)(nil),                    // 1: nodeum.micro.v1.Service
	(*ListServicesRequest)(nil),        // 2: nodeum.micro.v1.ListServicesRequest
	(*ListServicesResponse)(nil),       // 3: nodeum.micro.v1.ListServicesResponse
	(*Service_Node)(nil),               // 4: nodeum.micro.v1.Service.Node
	(*Service_Node_StatsResponse)(nil), // 5: nodeum.micro.v1.Service.Node.StatsResponse
}
var file_nodeum_micro_v1_monitoring_proto_depIdxs = []int32{
	4, // 0: nodeum.micro.v1.Service.nodes:type_name -> nodeum.micro.v1.Service.Node
	1, // 1: nodeum.micro.v1.ListServicesResponse.services:type_name -> nodeum.micro.v1.Service
	5, // 2: nodeum.micro.v1.Service.Node.stats:type_name -> nodeum.micro.v1.Service.Node.StatsResponse
	0, // 3: nodeum.micro.v1.Service.Node.status:type_name -> nodeum.micro.v1.Service.Node.Status
	2, // 4: nodeum.micro.v1.MonitoringService.ListServices:input_type -> nodeum.micro.v1.ListServicesRequest
	3, // 5: nodeum.micro.v1.MonitoringService.ListServices:output_type -> nodeum.micro.v1.ListServicesResponse
...
func file_nodeum_micro_v1_monitoring_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_nodeum_micro_v1_monitoring_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Service_Node_StatsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache

...
const (
	LicenseService_ShowLicense_FullMethodName   = "/nodeum.micro.v1.LicenseService/ShowLicense"
	LicenseService_UpdateLicense_FullMethodName = "/nodeum.micro.v1.LicenseService/UpdateLicense"
)
...
func (c *licenseServiceClient) ShowLicense(ctx context.Context, in *ShowLicenseRequest, opts ...grpc.CallOption) (*ShowLicenseResponse, error) {
	...
	err := c.cc.Invoke(ctx, LicenseService_ShowLicense_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *licenseServiceClient) UpdateLicense(ctx context.Context, in *UpdateLicenseRequest, opts ...grpc.CallOption) (*UpdateLicenseResponse, error) {
	...
	err := c.cc.Invoke(ctx, LicenseService_UpdateLicense_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LicenseService_ShowLicense_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: LicenseService_ShowLicense_FullMethodName,
	}

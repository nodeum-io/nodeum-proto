...
const (
	DebugService_Info_FullMethodName  = "/nodeum.micro.v1.DebugService/Info"
	DebugService_Stats_FullMethodName = "/nodeum.micro.v1.DebugService/Stats"
)
...
func (c *debugServiceClient) Info(ctx context.Context, in *InfoRequest, opts ...grpc.CallOption) (*InfoResponse, error) {
	...
	err := c.cc.Invoke(ctx, DebugService_Info_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *debugServiceClient) Stats(ctx context.Context, in *StatsRequest, opts ...grpc.CallOption) (*StatsResponse, error) {
	...
	err := c.cc.Invoke(ctx, DebugService_Stats_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _DebugService_Info_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DebugService_Info_FullMethodName,
	}
...
func _DebugService_Stats_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DebugService_Stats_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
const (
	MonitoringService_ListServices_FullMethodName = "/nodeum.micro.v1.MonitoringService/ListServices"
	MonitoringService_ListHosts_FullMethodName    = "/nodeum.micro.v1.MonitoringService/ListHosts"
)
...
func (c *monitoringServiceClient) ListServices(ctx context.Context, in *ListServicesRequest, opts ...grpc.CallOption) (*ListServicesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MonitoringService_ListServices_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *monitoringServiceClient) ListHosts(ctx context.Context, in *ListHostsRequest, opts ...grpc.CallOption) (*ListHostsResponse, error) {
	...
	err := c.cc.Invoke(ctx, MonitoringService_ListHosts_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil

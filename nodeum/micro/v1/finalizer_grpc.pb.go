...
const (
	FinalizerService_Start_FullMethodName  = "/nodeum.micro.v1.FinalizerService/Start"
	FinalizerService_Pause_FullMethodName  = "/nodeum.micro.v1.FinalizerService/Pause"
	FinalizerService_Resume_FullMethodName = "/nodeum.micro.v1.FinalizerService/Resume"
	FinalizerService_Stop_FullMethodName   = "/nodeum.micro.v1.FinalizerService/Stop"
)
...
func (c *finalizerServiceClient) Start(ctx context.Context, in *FinalizerServiceStartRequest, opts ...grpc.CallOption) (*FinalizerServiceStartResponse, error) {
	...
	err := c.cc.Invoke(ctx, FinalizerService_Start_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *finalizerServiceClient) Pause(ctx context.Context, in *FinalizerServicePauseRequest, opts ...grpc.CallOption) (*FinalizerServicePauseResponse, error) {
	...
	err := c.cc.Invoke(ctx, FinalizerService_Pause_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *finalizerServiceClient) Resume(ctx context.Context, in *FinalizerServiceResumeRequest, opts ...grpc.CallOption) (*FinalizerServiceResumeResponse, error) {
	...
	err := c.cc.Invoke(ctx, FinalizerService_Resume_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *finalizerServiceClient) Stop(ctx context.Context, in *FinalizerServiceStopRequest, opts ...grpc.CallOption) (*FinalizerServiceStopResponse, error) {
	...
	err := c.cc.Invoke(ctx, FinalizerService_Stop_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FinalizerService_Start_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FinalizerService_Start_FullMethodName,
	}
...
func _FinalizerService_Pause_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FinalizerService_Pause_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FinalizerService_Resume_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FinalizerService_Resume_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FinalizerService_Stop_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FinalizerService_Stop_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {

...
const (
	ConfigService_ShowConfig_FullMethodName   = "/nodeum.micro.v1.ConfigService/ShowConfig"
	ConfigService_UpdateConfig_FullMethodName = "/nodeum.micro.v1.ConfigService/UpdateConfig"
)
...
func (c *configServiceClient) ShowConfig(ctx context.Context, in *ShowConfigRequest, opts ...grpc.CallOption) (*ShowConfigResponse, error) {
	...
	err := c.cc.Invoke(ctx, ConfigService_ShowConfig_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ConfigService_ShowConfig_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ConfigService_ShowConfig_FullMethodName,
	}

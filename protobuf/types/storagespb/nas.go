...
func (n NASShare_Protocol) Version() string {
	switch n {
	case NASShare_NFS_V4:
		return "4.2"
	case NASShare_NFS_V3:
		return "3"
	case NASShare_SMB_V3:
		return "3.0"
	case NASShare_SMB_V2_1:
		return "2.1"
	case NASShare_SMB_V1:
		return "1.0"
	}
	return ""
}
